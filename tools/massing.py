...
SCENES = {
    ...
    'gyeongbokgung':((37.5740, 126.9660, 37.5860, 126.9885), 16, 0.74),
    'bukchon':      ((37.5770, 126.9790, 37.5890, 127.0015), 16, 0.74),
...
if __name__ == '__main__':
    ...
    for nm in want:
        if nm not in SCENES:
            ...
            continue
        bbox, rot, ppm = SCENES[nm]
        print('== %s %s' % (nm, bbox))
        try:
            build(nm, bbox, rot, ppm, marks=MARKS.get(nm, ()))
