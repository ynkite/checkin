...
package idusw.sbb.checkin.domain.auth.controller;

import idusw.sbb.checkin.domain.auth.dto.PasswordResetDTO;
...
import idusw.sbb.checkin.domain.auth.service.AuthService;
import idusw.sbb.checkin.global.common.ApiResponse;
import idusw.sbb.checkin.domain.auth.service.EmailAuthService;
...
public class AuthController {
    ...
    public ResponseEntity<String> resetPasswordRequest(@RequestBody java.util.Map<String, String> request) {
        ...
        if (!authService.checkEmail(email)) {
            return ResponseEntity.badRequest().body("체크인에 가입되지 않은 이메일입니다.");
        }
