package idusw.sbb.checkin.domain.planshare.service;
...
import idusw.sbb.checkin.domain.planshare.dto.ShareInviteRequestDto;
import idusw.sbb.checkin.domain.planshare.dto.TripMemberResponseDto;
...
public class TripShareService {
    ...
    private void sendInviteEmail(String email, String name, String planTitle, Long tripId) {
        ...
        message.setTo(email);
        message.setSubject("[체크인] '" + planTitle + "' 여행 플랜에 초대되었습니다 ✈️");
