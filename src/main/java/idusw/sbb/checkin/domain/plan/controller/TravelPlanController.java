package idusw.sbb.checkin.domain.plan.controller;

import idusw.sbb.checkin.domain.auth.security.CustomUserDetails;  // ← LoginUser 대신
...
import idusw.sbb.checkin.domain.plan.service.TravelPlanService;
...
public class TravelPlanController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<idusw.sbb.checkin.domain.plan.dto.TripListResponseDto>>> getMyPlans(
            @AuthenticationPrincipal CustomUserDetails userDetails) {
        List<idusw.sbb.checkin.domain.plan.dto.TripListResponseDto> plans = travelPlanService.getMyTripList(userDetails.getUserId());
