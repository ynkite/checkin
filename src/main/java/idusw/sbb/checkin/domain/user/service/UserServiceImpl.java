package idusw.sbb.checkin.domain.user.service;

import idusw.sbb.checkin.domain.auth.entity.OAuthAccount;
import idusw.sbb.checkin.domain.auth.repository.OAuthAccountRepository;
import idusw.sbb.checkin.domain.auth.repository.RefreshTokenRepository;
...
import idusw.sbb.checkin.domain.place.entity.Place;
import idusw.sbb.checkin.domain.place.repository.PlaceRepository;
import idusw.sbb.checkin.domain.post.repository.PlaceReviewRepository;
...
import idusw.sbb.checkin.domain.user.dto.ScrapResponseDto;
import idusw.sbb.checkin.domain.user.entity.Scrap;
import idusw.sbb.checkin.domain.user.dto.UserInfoResponseDto;
import idusw.sbb.checkin.domain.user.dto.UserNicknameUpdateRequest;
import idusw.sbb.checkin.domain.user.entity.SecurityEventType;
import idusw.sbb.checkin.domain.user.entity.User;
import idusw.sbb.checkin.domain.user.entity.UserSecurityHistory;
import idusw.sbb.checkin.domain.user.repository.ScrapRepository;
import idusw.sbb.checkin.domain.user.repository.UserRepository;
import idusw.sbb.checkin.domain.user.repository.UserSecurityHistoryRepository;
