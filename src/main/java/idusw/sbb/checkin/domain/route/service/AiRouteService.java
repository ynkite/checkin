        ...
        String prompt = String.format("""
            ...
            5. 예산 및 상세 정보(sub) 무결성:
               - 별점(stars): ★절대 임의로 별점을 지어내지 마세요★. 실제 평점 데이터를 모르면
                 ...
                 (시스템이 체크인 커뮤니티/카카오맵 실제 평점이 있으면 그 값으로 덮어씁니다.)
...
//                updatedJson = fallbackClient.prompt().user(prompt).call().content();
    ...
    public String generateCandidatesByAi(Long tripId) {
        ...
        String prompt = "당신은 '체크인'의 여행 장소 조사 전문 AI입니다.\n"
    ...
    private String buildRouteWithAI(
        ...
        String prompt = "당신은 '체크인'의 최적 동선 생성 AI입니다.\n"
