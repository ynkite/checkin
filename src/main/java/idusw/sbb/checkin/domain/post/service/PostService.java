package idusw.sbb.checkin.domain.post.service;
...
import idusw.sbb.checkin.domain.place.service.PlaceService;
import idusw.sbb.checkin.domain.post.dto.*;
import idusw.sbb.checkin.domain.post.entity.*;
import idusw.sbb.checkin.domain.post.repository.*;
