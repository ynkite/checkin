package idusw.sbb.checkin.domain.post.controller;

import idusw.sbb.checkin.domain.auth.security.CustomUserDetails;
import idusw.sbb.checkin.domain.post.dto.PlaceReviewResponseDto;
import idusw.sbb.checkin.domain.post.dto.PlaceReviewSaveDto;
import idusw.sbb.checkin.domain.post.dto.PlaceReviewUpdateDto;
import idusw.sbb.checkin.domain.post.dto.PostDetailResponseDto;
import idusw.sbb.checkin.domain.post.dto.PostListResponseDto;
import idusw.sbb.checkin.domain.post.dto.PostWriteDto;
import idusw.sbb.checkin.domain.post.service.PostService;
import idusw.sbb.checkin.domain.system.dto.ReportRequestDto;
import idusw.sbb.checkin.domain.system.service.SystemService;
import idusw.sbb.checkin.global.common.ApiResponse;
import idusw.sbb.checkin.global.service.LocalFileService;
