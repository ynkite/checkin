...
public class ChatbotServiceImpl implements ChatbotService {
    ...
    public String processMessage(Long sessionId, String message) {
        ...
        sysPrompt.append("""
                ...
                [절대 규칙 - 하드코딩, 예외 없음]
                1. 해외 여행지(일본, 도쿄, 오사카, 미국, 뉴욕, 파리, 유럽, 방콕, 베트남, 싱가포르, 홍콩, 대만, 중국 등)가
                   실제 여행지로 언급되면 다른 설명 없이 반드시 이 문장만 답하세요: "본 서비스는 국내 전용입니다. 국내 도시를 입력해 주세요"
                   단, "파리바게뜨"처럼 해외 키워드가 포함된 국내 상호명·브랜드명·장소명은 해외 여행지 언급으로 간주하지 마세요.
